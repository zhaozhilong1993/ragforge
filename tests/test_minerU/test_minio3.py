...
pdf_file_name= '0618a7c522bb504f58a2310effaa8d2b5a113b828df8dca54be7ac288081ee61.jpg'
pdf_file_name = '一汽物流需求-场景v1.0.pptx'
pdf_bytes = reader.read(pdf_file_name)

from magic_pdf.utils.office_to_pdf import convert_file_to_pdf, ConvertToPdfError

datasets = convert_file_to_pdf(pdf_bytes)
